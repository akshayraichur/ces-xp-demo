...
import { postAConference } from "../../Helpers/Conf";
...
export const AddConference = () => {
  ...
  const onSubmitHandler = (values) => {
    ...
    postAConference(formData, access_token)
      .then((data) => {
        if (data.err) {
          setErr(data.err);
        } else {
      ...
      <div>
        <Container component="main" maxWidth="xs" className="my-5">
          <Grid container spacing={4}>
            <Grid item xs={12}>
              <h2 className="h2-responsive text-center">Add Conference!</h2>
            </Grid>
            ...
            <Grid item sx={12}>
              <form noValidate onSubmit={formik.handleSubmit}>
                ...
                <TextField
                  fullWidth
                  error={
                    formik.errors.dateOfConference &&
                    formik.touched.dateOfConference
                      ? true
                      : false
                  }
                  variant="filled"
                  ...
                  onChange={formik.handleChange}
                  onBlur={formik.handleBlur}
                  value={formik.values.dateOfConference}
                />
